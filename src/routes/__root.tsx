...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      ...DEV_NO_STORE_META,
      { title: "Nancy Clarke — New Construction Realtor | St. Lucie FL" },
      {
        name: "description",
        content:
      ...
      { property: "og:site_name", content: "Nancy Clarke" },
      ...
      { name: "twitter:title", content: "Nancy Clarke — New Construction Realtor" },
      {
