...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "The #1 Adams Homes Sales Associate in St. Lucie County. Realtors keep 100% of their buyer-side commission." },
      { property: "og:site_name", content: "Nancy Clarke Realtor" },
